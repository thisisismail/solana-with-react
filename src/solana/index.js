...
export async function setPayerAndBlockhashTransaction(instructions, wallet) {
...
export async function signAndSendTransaction(transaction, wallet) {
  try {
...
async function checkWallet(wallet) {
  console.log("meeeeeeeeeeeeeeeeeeeeeeeee");
  if (!wallet.connected) {
    await wallet.connect();
  }
}

export async function createCampaign(name, description, image_link, wallet) {
...
export async function withdraw(campaignPubKey, amount, wallet) {
  await checkWallet(wallet);
